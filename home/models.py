...
class Review(models.Model):
    ...
    shop = models.ForeignKey(CoffeeShop, on_delete=models.CASCADE, related_name='reviews', null=True, blank=True)
    ...
    class Meta:
        ordering = ['-created_at']
        constraints = [
            models.UniqueConstraint(fields=['user', 'shop'], name='one_review_per_user_per_shop')
        ]